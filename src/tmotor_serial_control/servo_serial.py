...
Servo_Params_Serial = {
    'AK80-64': {
        'Type' : 'AK80-64', # name of motor to print out in diagnostics
        'P_min' : -12.5, # rad (-58.85 rad limit)
        'P_max' : 12.5, # rad (58.85 rad limit)
        'V_min' : -8.0, # rad/s (-58.18 rad/s limit)
        'V_max' : 8.0, # rad/s (58.18 rad/s limit)
...
class TMotorManager():
    ...
    """
    def __init__(self, port = '/dev/ttyUSB0', baud=961200, motor_params=Servo_Params_Serial['AK80-64'], max_mosfett_temp = 50,):
        """
    ...
    def get_motor_angle_radians(self):
        ...
        """
        return self._motor_state.position_set*self.motor_params["GEAR_RATIO"]
    ...
    def get_motor_velocity_radians_per_second(self):
        ...
        """
        return self._motor_state.speed*self.motor_params["GEAR_RATIO"]
